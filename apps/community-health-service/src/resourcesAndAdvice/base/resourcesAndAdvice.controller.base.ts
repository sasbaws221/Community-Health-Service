...
export class ResourcesAndAdviceControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: ResourcesAndAdvice })
  ...
  async createResourcesAndAdvice(
    @common.Body() data: ResourcesAndAdviceCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [ResourcesAndAdvice] })
  ...
  async resourcesAndAdvices(
    ...
    const args = plainToClass(ResourcesAndAdviceFindManyArgs, request.query);
    return this.service.resourcesAndAdvices({
      ...args,
      select: {
        author: true,
  ...
  async resourcesAndAdvice(
    @common.Param() params: ResourcesAndAdviceWhereUniqueInput
  ): Promise<ResourcesAndAdvice | null> {
    const result = await this.service.resourcesAndAdvice({
      where: params,
      select: {
        author: true,
  ...
  async updateResourcesAndAdvice(
    @common.Param() params: ResourcesAndAdviceWhereUniqueInput,
    @common.Body() data: ResourcesAndAdviceUpdateInput
  ): Promise<ResourcesAndAdvice | null> {
    try {
  ...
  async deleteResourcesAndAdvice(
    ...
    try {
      return await this.service.deleteResourcesAndAdvice({
        where: params,
        select: {
          author: true,
  ...
  async connectComment(
    ...
    await this.service.updateResourcesAndAdvice({
      where: params,
      data,
      select: { id: true },
    });
