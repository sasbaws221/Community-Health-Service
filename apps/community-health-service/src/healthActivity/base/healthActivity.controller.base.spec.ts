...
const service = {
  ...
  healthActivities: () => FIND_MANY_RESULT,
  healthActivity: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("HealthActivity", () => {
  ...
  test("POST /healthActivities", async () => {
    await request(app.getHttpServer())
      .post("/healthActivities")
      .send(CREATE_INPUT)
  ...
  test("GET /healthActivities", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /healthActivities/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/healthActivities"}/${nonExistingId}`)
  ...
  test("GET /healthActivities/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/healthActivities"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /healthActivities existing resource", async () => {
