...
@InputType()
class ResourcesAndAdviceCreateNestedManyWithoutCategoriesInput {
...
export { ResourcesAndAdviceCreateNestedManyWithoutCategoriesInput as ResourcesAndAdviceCreateNestedManyWithoutCategoriesInput };
