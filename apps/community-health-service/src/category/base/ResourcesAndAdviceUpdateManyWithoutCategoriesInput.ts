...
@InputType()
class ResourcesAndAdviceUpdateManyWithoutCategoriesInput {
...
export { ResourcesAndAdviceUpdateManyWithoutCategoriesInput as ResourcesAndAdviceUpdateManyWithoutCategoriesInput };
